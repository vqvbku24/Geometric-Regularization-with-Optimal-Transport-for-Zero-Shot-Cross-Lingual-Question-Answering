# arabic/generate_preds_ar.py
"""
Generate predictions JSON for Arabic QA evaluation.

Works with both XQuAD-ar and MLQA-ar JSON files (SQuAD format).
...
Usage:
    python arabic/generate_preds_ar.py \\
        ...
        --ckpt checkpoint_stage2_ar/stage2_best.pt \\
        --eval_file dataset/MLQA/test-context-ar-question-ar.json \\
        --output_pred_file arabic_mlqa_preds.json

    # Zero-shot (stage1 only, no stage2):
    python arabic/generate_preds_ar.py \\
        --ckpt checkpoints/stage1_squad_best.pt \\
        --eval_file dataset/MLQA/test-context-ar-question-ar.json \\
        --output_pred_file arabic_zeroshot_preds.json \\
        --zero_shot
"""
import json
import torch
            ...
            for paragraph in article['paragraphs']:
                ...
                for qa in paragraph['qas']:
                    ...
                    for w in range(num_windows):
                        ...
                        # Mask question tokens, keep [CLS] masked (force answerable for AR generation)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate AR QA predictions')
    ...
    parser.add_argument('--eval_file',        type=str, required=True,
                        help='XQuAD-ar or MLQA-ar JSON file')
    parser.add_argument('--output_pred_file', type=str, default='ar_preds.json')
